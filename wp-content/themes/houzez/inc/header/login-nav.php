        ...
        <li>
            ...
            <div class="account-dropdown">
                <ul>
                    ...
                    echo '<li><a href="' . site_url('viewings') . '"> <i class="fa fa-eye"></i>' . esc_html__('Viewings', 'houzez') . '</a></li>';
					
					$user = wp_get_current_user();

					if( in_array( Homi_Addons::SELLER_ROLE , (array) $user->roles ) || in_array( 'administrator', (array) $user->roles ) ) {

						echo '<li><a href="' . site_url('my-properties') . '"> <i class="fa fa-home"></i>' . esc_html__('My properties', 'houzez') . '</a></li>';
						echo '<li><a href="' . site_url('property-availability') . '"> <i class="fa fa-calendar"></i>' . esc_html__('My availability', 'houzez') . '</a></li>';
						 echo '<li><a href="' . site_url('property-upload') . '"> <i class="fa fa-upload"></i>' . esc_html__('Upload Property', 'houzez') . '</a></li>';
						 echo '<li><a href="' . site_url('my-valuations') . '"> <i class="fa fa-file"></i>' . esc_html__('My Valuations', 'houzez') . '</a></li>';
...
<?php } else { ?>
    <div class="user">
            ...
            if( houzez_option('header_login') != 'no' ) {
                ...
                echo '<a href="'.wp_login_url().'" ><i class="fa fa-user hidden-md hidden-lg"></i> <span class="hidden-sm hidden-xs">'.esc_html__( 'Sign In', 'houzez' ).'</span></a>';
				
                echo '<a href="'.wp_registration_url().'" ><i class="fa fa-user hidden-md hidden-lg"></i> <span class="hidden-sm hidden-xs">'.esc_html__( 'Register', 'houzez' ).'</span></a>';
            }
