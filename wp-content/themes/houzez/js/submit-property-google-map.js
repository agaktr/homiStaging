...
jQuery(document).ready( function($) {
    ...
    var geo_country_limit = HOUZEZ_ajaxcalls_vars.geo_country_limit;
    var geocomplete_country = HOUZEZ_ajaxcalls_vars.geocomplete_country;
    var map;
    var marker;
    ...
    if (document.getElementById('geocomplete')) {
        ...
        if (document.getElementById('houzez_edit_map')) {
