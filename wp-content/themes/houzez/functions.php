...
define( 'HOUZEZ_THEME_VERSION', '1.8.3' );
/**
*	----------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 *	---------------------------------------------------------------------------------------
 */
require_once(get_theme_file_path('/inc/widgets/houzez-featured-properties.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-properties.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-property-taxonomies.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-advanced-search.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-contact.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-latest-posts.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-code-banner.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-about.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-facebook.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-flickr-photos.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-image-banner-300-250.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-mortgage-calculator.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-instagram.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-twitter.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-properties-viewed.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-agents-search.php'));
require_once(get_theme_file_path('/inc/widgets/houzez-agency-search.php'));
...
require_once( get_template_directory() . '/framework/metaboxes/property-type-meta.php' );
