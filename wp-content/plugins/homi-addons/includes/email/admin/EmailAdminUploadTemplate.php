...
class EmailAdminUploadTemplate
{
                                            ...
                                            <tr id="emailBody">
                                                <td>
                                                    <table class="emailInfo" style="font-size: 13px;margin: 20px 15px;width: 100%;">
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <strong style="display: block;margin: 20px 2px 5px;color: #045fb4;">
                                                                    Landlord details
                                                                </strong>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td style="border-bottom: 1px solid #e5e5e5;padding-bottom: 20px;">
                                                                <table style="font-size: 13px;line-height: 20px;">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <?php echo $request->user->first_name; ?> <?php echo $request->user->last_name; ?>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="color: #666;">
                                                                        ...
                                                                        <td>
                                                                           <?php echo get_user_meta( $request->user->ID, 'fave_author_mobile', true ); ?>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="color: #666;">
                                                                        ...
                                                                        <td>
                                                                            <a href="mailto:<?php echo $request->user->user_email; ?>">
                                                                                <?php echo $request->user->user_email; ?>
                                                                            </a>
