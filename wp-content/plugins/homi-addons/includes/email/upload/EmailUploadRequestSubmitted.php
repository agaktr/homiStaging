...
class EmailUploadRequestSubmitted
{

    /**
     * @param $uploadRequest UploadRequest
     */
    public function get_template($uploadRequest ){
        ...
        <div id="m_-5385044607299061000ac-designer" class="m_-5385044607299061000body" style="font-family:Arial;line-height:1.1;margin:0px;background-color:#cce0ff;width:100%;text-align:center">
            <div style="display:none;padding:0;height:1px;font-size:1px;background-color:inherit!important;color:inherit!important;line-height:1px">
                Επιτυχής υποβολή των στοχείων ακινήτου
            </div>
                                                                            ...
                                                                            <div style="margin:0;outline:none;padding:0;font-size:25px;color:#ffffff;font-family:arial,helvetica,sans">
                                                                                ...
                                                                                <div style="margin:0;outline:none;padding:0;color:#1259af;font-family:arial,helvetica,sans;font-weight:700;font-size:25px;text-align:center">
																									<span style="color:#1259af;font-size:inherit;font-weight:inherit;line-height:inherit;text-decoration:inherit">
																										<span style="color:#1259af;font-size:25px;font-weight:700;line-height:inherit;text-decoration:inherit;font-family:arial,helvetica,sans;font-style:normal">Επιτυχής υποβολή των στοχείων ακινήτου</span>
																									</span>
                                                                                </div>
                                                                            </div>
                                                                        </td>
                                                                                ...
                                                                                <div style="margin:0;outline:none;padding:0;text-align:center">
                                                                                    ...
                                                                                    <div style="margin:0;outline:none;padding:0;text-align:justify;font-size:15px">
																																											<span style="color:inherit;font-size:inherit;font-weight:inherit;line-height:inherit;text-decoration:inherit;font-family:arial,helvetica,sans"> Αγαπητή/έ
																																												<span style="color:#000000;font-size:inherit;font-weight:inherit;line-height:inherit;text-decoration:inherit"><?php echo $uploadRequest->user->first_name; ?>,</span>
																																											</span>
                                                                                    </div>
                                                                                    <span style="color:inherit;font-size:inherit;font-weight:inherit;line-height:inherit;text-decoration:inherit;text-align:center">
																																											<div style="margin:0;outline:none;padding:0;text-align:justify;font-size:15px">
																																												...
																																												<div style="margin:0;outline:none;padding:0;text-align:justify;font-size:15px">
																																													<span style="color:inherit;font-size:inherit;font-weight:inherit;line-height:inherit;text-decoration:inherit;font-family:arial,helvetica,sans">Τα στοιχεία της ιδιοκτησίας σου αποθηκεύτηκαν με επιτυχία.
																																														<br>
																																														</span>
																																													</div>
																																												</span>
            ...
            <div id="m_-5385044607299061000ac-footer" style="clear:both;background-color:inherit;background:inherit;min-width:100%;padding:20px;color:#000000;font-size:11px;font-family:arial,helvetica,sans-serif;line-height:140%;line-height:1.4;text-align:center;box-sizing:border-box">
                <center>
                    ...
                    <span style="font-size:11px;font-family:arial,helvetica,sans-serif;font-weight:normal;text-decoration:none;outline:none">
																																	<a href="mailto:<?php echo $uploadRequest->user->user_email; ?>" target="_blank"><?php echo $uploadRequest->user->user_email; ?></a>
																																</span>
                    <br>
                    <br>
