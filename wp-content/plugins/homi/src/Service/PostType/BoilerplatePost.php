...
class BoilerplatePost implements TemplatesInterface{
    ...
    public function registerPostType() {
        ...
        $labels = array(
            'name'               => __( 'Episodes', Homi::PLUGIN_NAME ),
            'singular_name'      => __( 'Episode', Homi::PLUGIN_NAME ),
            'menu_name'          => _x( 'Episodes', 'admin menu', Homi::PLUGIN_NAME ),
            'name_admin_bar'     => _x( 'Episode', 'add new on admin bar', Homi::PLUGIN_NAME ),
            'add_new'            => _x( 'Add New Episode', Homi::PLUGIN_NAME ),
            'add_new_item'       => __( 'Add New Episode', Homi::PLUGIN_NAME ),
            'new_item'           => __( 'New Episode', Homi::PLUGIN_NAME ),
            'edit_item'          => __( 'Edit Episode', Homi::PLUGIN_NAME ),
            'view_item'          => __( 'View Episode', Homi::PLUGIN_NAME ),
            'all_items'          => __( 'All Episodes', Homi::PLUGIN_NAME ),
            'search_items'       => __( 'Search Episodes', Homi::PLUGIN_NAME ),
            'parent_item_colon'  => __( 'Parent Episodes:', Homi::PLUGIN_NAME ),
            'not_found'          => __( 'No Episodes found.', Homi::PLUGIN_NAME ),
            'not_found_in_trash' => __( 'No Episodes found in Trash.', Homi::PLUGIN_NAME )
        );

        $args = array(
            'label'                 => __( 'Episodes', Homi::PLUGIN_NAME ),
            'labels'                => $labels,
            'description'           => '',
            'public'                => true,
        ...
        $meta_boxes[] = array(
            ...
            'fields'     => array(
                array(
                    ...
                    'name' => esc_html__( 'Episode Number', Homi::PLUGIN_NAME ),
                    'type' => 'text',
                ),
            ),
        );
