...
class PropertyObjectPost implements TemplatesInterface{
     ...
     * @var string
     */
    const POST_TYPE_NAME = 'property_object';
    ...
    public function registerPostType() {
        ...
        $labels = array(
            'name'               => __( 'Property Objects', Homi::PLUGIN_NAME ),
            'singular_name'      => __( 'Property Object', Homi::PLUGIN_NAME ),
            'menu_name'          => _x( 'Property Objects', 'admin menu', Homi::PLUGIN_NAME ),
            'name_admin_bar'     => _x( 'Property Object', 'add new on admin bar', Homi::PLUGIN_NAME ),
            'add_new'            => _x( 'Add New Property Object', Homi::PLUGIN_NAME ),
            'add_new_item'       => __( 'Add New Property Object', Homi::PLUGIN_NAME ),
            'new_item'           => __( 'New Property Object', Homi::PLUGIN_NAME ),
            'edit_item'          => __( 'Edit Property Object', Homi::PLUGIN_NAME ),
            'view_item'          => __( 'View Property Object', Homi::PLUGIN_NAME ),
            'all_items'          => __( 'All Property Objects', Homi::PLUGIN_NAME ),
            'search_items'       => __( 'Search Property Objects', Homi::PLUGIN_NAME ),
            'parent_item_colon'  => __( 'Parent Property Objects:', Homi::PLUGIN_NAME ),
            'not_found'          => __( 'No Property Objects found.', Homi::PLUGIN_NAME ),
            'not_found_in_trash' => __( 'No Property Objects found in Trash.', Homi::PLUGIN_NAME )
        );

        $args = array(
            'label'                 => __( 'Property Objects', Homi::PLUGIN_NAME ),
            'labels'                => $labels,
            'description'           => '',
            'public'                => true,
            ...
            'rewrite'               => array( 'slug' => 'dashboard/property-objects/edit', 'with_front' => false ),
            'has_archive'           => true,
            'show_in_menu'          => 'homi',
...
//        add_rewrite_rule('^podcasts/([^/]+)/([^/]+)/?$','index.php?castify_episode=$matches[2]','top');
        ...
        $meta_boxes[] = array(
            ...
            'fields'     => array(
                array(
                    ...
                    'name' => esc_html__( 'Property Object Number', Homi::PLUGIN_NAME ),
                    'type' => 'text',
                ),
            ),
        );
    ...
    public function customPostTypeTemplateSingle( $single_template ) {
        ...
        $template   = $this->getPluginDirPath() . self::SINGLE_TEMPLATES_FOLDER . "property-object.php";
    ...
    public function customPostTypeTemplateArchive( $archive_template ) {
        ...
        $template = $this->getPluginDirPath() . self::ARCHIVE_TEMPLATES_FOLDER . "property-objects.php";
