...
use Homi\Traits\Settings as SettingsFields;
...
class Settings {
    ...
    public function addSettingsMenu(){
        $page = add_submenu_page( 'homi','Homi Settings', 'Settings', 'manage_options' , 'homi-settings',  array( $this, 'settingsPage' ) );
    }
...
//        echo $plugin_file;
        if( $plugin_file === 'homi/homi.php' ) {

            $settings_link = array( '<a href="admin.php?page=' . $this->plugin_slug . '-settings">' . __( 'Settings', $this->textdomain ) . '</a>' );
