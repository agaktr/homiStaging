...
use Homi\Controller\Cron\CronController;
...
class CronJobs {
    ...
    public function __construct( $loader ){
        ...
        $this->loader       = $loader;
        $this->cronEvents   = ( defined('Homi\Controller\Cron\CronController::CRON_EVENTS') ? CronController::CRON_EVENTS : false );
     ...
     * the @see \Homi\Controller\Cron\CronController class
     *
     */
