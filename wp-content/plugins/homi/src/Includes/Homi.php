...
use Homi\Traits\Hooks;
use Homi\Interfaces\PluginInterface;
 ...
 */
class Homi implements PluginInterface {
	...
	public function __construct() {
		...
		$this->version          = ( defined( 'HOMI_VERSION' ) ? HOMI_VERSION : self::PLUGIN_VERSION );
	 ...
	 *
	 * Uses the @see \Homi\Includes\I18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
