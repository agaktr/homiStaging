...
namespace Homi\Controller\Front;

use Homi\Interfaces\PublicInterface;
 ...
 *
 * @package    Homi
 * @subpackage Homi/Controller/Front
 */
...
class PublicController implements PublicInterface {
	...
	public function pluginNameBodyClass( $classes ){
        ...
        $classes[] = ( $dashboard->isDashboardPage() ? 'homi-dashboard-page' : '');
		return $classes;
